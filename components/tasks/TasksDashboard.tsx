        ...
        {[
          ...
          <div key={i} className={`${s.bg} p-6 rounded-2xl flex flex-col justify-between relative overflow-hidden transition-all hover:scale-[1.02] ${s.glow}`}>
            <div className="flex justify-between items-start mb-4">
              <span className="text-[10px] font-bold italic text-white/70 tracking-widest">{s.label}</span>
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <GlassPanel className="p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h4 className="text-xs font-bold italic text-white tracking-widest font-sans">Quick Add Task</h4>
            </div>
          ...
          <GlassPanel className="p-0 overflow-hidden">
            <div className="px-8 py-5 border-b border-white/5 bg-white/[0.01] flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <h4 className="text-[10px] font-bold italic text-zinc-400 tracking-widest font-sans">Recent Tasks</h4>
              </div>
              <button onClick={onNavigateToAll} className="bg-white/5 px-4 py-1.5 rounded-lg text-[9px] font-bold italic text-zinc-400 hover:text-white transition-all tracking-widest border border-white/5">
                View All
              </button>
            </div>
