  ...
  return (
    <div className="space-y-8 font-sans">
      ...
      <div className="flex items-center space-x-3 mb-6">
        ...
        <h3 className="text-xs font-bold italic text-zinc-500">Strategic Risk Heatmap</h3>
      </div>
        ...
        <div className="grid grid-cols-4 gap-6 px-1">
          <div className="text-center group">
            <div className="flex items-center justify-center space-x-2 mb-3">
              ...
              <span className="text-xs font-bold italic text-zinc-500 opacity-60">Critical</span>
            </div>
            <p className="text-2xl font-bold italic text-white tabular-nums tracking-tighter">{counts.critical}</p>
          </div>
          <div className="text-center group">
            <div className="flex items-center justify-center space-x-2 mb-3">
              <div className="w-2 h-2 rounded-full bg-amber-500"></div>
              <span className="text-xs font-bold italic text-zinc-500 opacity-60">High</span>
            </div>
            <p className="text-2xl font-bold italic text-white tabular-nums tracking-tighter">{counts.high}</p>
          </div>
          <div className="text-center group">
            <div className="flex items-center justify-center space-x-2 mb-3">
          ...
          <div className="text-center group">
            <div className="flex items-center justify-center space-x-2 mb-3">
              ...
              <span className="text-xs font-bold italic text-zinc-500 opacity-60">Stable</span>
            </div>
            <p className="text-2xl font-bold italic text-white tabular-nums tracking-tighter">{counts.stable}</p>
          </div>
        </div>
      </div>
    </div>
