         ...
         {systems.map((s) => (
           ...
           >
                 <div className="flex justify-between items-start mb-8 relative z-10">
                    ...
                    <div className={`text-[9px] font-bold italic tracking-[0.2em] px-3 py-1 rounded-full border transition-all ${
            ...
            <div className="p-10 space-y-6">
                  ...
                  {logs.length === 0 && (
                    <div className="py-24 text-center opacity-30 flex flex-col items-center gap-6 grayscale">
                       ...
                       <p className="text-[12px] font-bold italic tracking-[0.5em] text-zinc-600">No active signal modulation detected</p>
                    </div>
                  )}
            </div>
         </div>
