...
export const NexusCopilot: React.FC = () => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const assistantMsg: Message = {
                ...
                role: 'assistant',
                content: data.response || "I'm having trouble connecting to my neural core.",
                timestamp: new Date()
            };
    ...
    return (
        <div className="fixed bottom-6 right-6 z-[9999] font-sans">
            {/* Chat Window */}
            {isOpen && (
                <div className="absolute bottom-20 right-0 w-[400px] h-[600px] bg-[#0A0A0A]/95 border border-cyan-500/30 rounded-2xl shadow-[0_0_50px_rgba(0,255,255,0.15)] flex flex-col backdrop-blur-xl overflow-hidden animate-in slide-in-from-bottom-5 duration-300">
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-white/10 bg-white/5">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-white tracking-wide">Nexus Co-Pilot</h3>
                            ...
                            >
                                ...
                                <div
                                    className={`max-w-[80%] rounded-2xl px-4 py-3 text-sm leading-relaxed ${msg.role === 'user'
                                        ? 'bg-cyan-500 text-black font-medium rounded-tr-sm shadow-[0_0_15px_rgba(34,211,238,0.3)]'
                    ...
                    <div className="p-4 border-t border-white/10 bg-white/[0.02]">
                        ...
                        <div className="text-[10px] text-center text-zinc-600 mt-2 font-medium tracking-wide">
