    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-white tracking-tight font-brand uppercase">User Profile</h1>
                    <p className="text-sm text-zinc-400">Manage your identity and preferences</p>
                </div>
                <button
                    onClick={() => signOut()}
                    className="flex items-center space-x-2 px-4 py-2 bg-zinc-800 text-zinc-300 rounded-lg hover:bg-zinc-700 hover:text-white transition-all border border-zinc-700"
                >
                    <LogOut size={16} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1 space-y-6">
                    <div className="bg-[var(--surface-elevated)] border border-[var(--surface-border)] rounded-2xl p-6 flex flex-col items-center text-center shadow-lg relative overflow-hidden">
                ...
                <div className="md:col-span-2 space-y-6">
                    {/* Preferences */}
                    <div className="bg-[var(--surface-base)] border border-[var(--surface-border)] rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="bg-[var(--surface-base)] border border-[var(--surface-border)] rounded-2xl p-6 shadow-sm">
                        ...
                        <div className="mt-8 flex justify-end">
                            <button onClick={handleSave} className="flex items-center space-x-2 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 font-bold uppercase text-xs tracking-wider transition-all shadow-[0_0_15px_rgba(37,99,235,0.3)]">
                                <Save size={16} />
