...
const STANDARDS = {
  ...
  typography: {
    ...
    h1: 'font-bold italic', // Updated to match normalized standard
...
const ALLOWED_HEX = [
  '#c21719', '#0b0c10', '#15171e', '#1c1f26', '#ffffff', '#000000', '#050505', '#0a0a0a',
  '#3b82f6', '#f43f5e', '#06b6d4', '#10b981', '#f59e0b', '#fbbf24', '#f5a623',
  '#444444', '#1e293b', '#0f172a', '#0a0f2c', '#00ff9f', '#ff3b3b', '#20b2aa', '#52525b', '#123'
];
