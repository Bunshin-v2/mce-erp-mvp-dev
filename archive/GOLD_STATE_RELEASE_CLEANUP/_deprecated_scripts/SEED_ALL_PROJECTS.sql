-- SEED DATA: All 33 Projects from Master Document
-- 100% Data Parity with "Ongoing, Completed & Upcoming Projects FV"

-- 1. Clear existing projects
DELETE FROM projects_master;

-- 2. Insert Ongoing Projects
